  ...
  <body>
    ...
    <table>
        <tr style="background-color:black;">
            <td style="padding:10px; font-size: 20px; color:white;">Název produktu</td>
            <td style="padding:10px; font-size: 20px; color:white;">Kvantita</td>
            <td style="padding:10px; font-size: 20px; color:white;">Cena</td>
            <td style="padding:10px; font-size: 20px; color:white;">Odstranění</td>
        </tr>
        ...
        <tr style="background-color: black;">
            ...
            <td style="padding: 10px; color:white;"><a class="btn btn-danger" href="{{url('delete',$carts->id)}}">Odstranit</a></td>
        </tr>
        @endforeach
    </table>
    <button class="btn btn-success">Potvrdit objedávku</button>
    </form>
    </div>
