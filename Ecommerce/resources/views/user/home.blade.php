        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>Vítejte na stránkách o virtuální realitě s vlastním E-Shopem.</h2>
            </div>
          </div>
          <div class="col-md-6">
            <div class="left-content">
              <h4></h4>
              <p style="font-size:20px;">Virtální realita je technologie, která umožňuje uživateli pohybovat se v simulovaném prostředí. Na těchto stránkách se můžete dozvědět zajímavé informace o virtuální realitě, jaké zařízení zakoupit a jaké hry třeba vyzkoušet.</p>
              <a href="{{url('ovr')}}" class="filled-button">Více informací</a>
            </div>
          </div>
          <div class="col-md-6">
